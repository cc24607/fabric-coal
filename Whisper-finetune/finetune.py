...
add_arg("train_data",    type=str, default="dataset/train1.json",       help="训练数据集的路径")
add_arg("test_data",     type=str, default="dataset/test1.json",        help="测试数据集的路径")
add_arg("base_model",    type=str, default="D:\zpc\whisper_large_v2",      help="Whisper的基础模型")
add_arg("output_dir",    type=str, default="output4_v2/",                  help="训练保存模型的路径")
...
add_arg("num_train_epochs", type=int, default=6,      help="训练的轮数")
