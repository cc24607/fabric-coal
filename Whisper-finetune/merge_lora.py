...
add_arg("lora_model", type=str, default="output4_v2/whisper_large_v2/checkpoint-best/", help="微调保存的模型路径")
add_arg('output_dir', type=str, default='models/V2/',    help="合并模型的保存目录")
