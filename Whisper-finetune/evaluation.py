...
add_arg("test_data",   type=str, default="dataset/test1.json",            help="测试集的路径")
add_arg("model_path",  type=str, default="models/2/whisper_model_v3-finetune", help="合并模型的路径，或者是huggingface上模型的名称")
