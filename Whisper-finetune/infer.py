...
add_arg("audio_path", type=str, default="uploads/001.wav", help="预测的音频路径")
add_arg("model_path", type=str, default="models/V2/whisper_large_v2-finetune/",
...
def getChunkStr():
    str = ''
    for chunk in result["chunks"]:
        str += f"[{chunk['timestamp'][0]}-{chunk['timestamp'][1]}s] {chunk['text']}"
        str += "\n"
    return str
