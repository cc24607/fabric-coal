	...
	<div class="app-container">
		...
		<el-card style="width: 27%;height: 100%;margin-left: 15px;float: right;">
			...
			<el-card style="width: 100%;">
				...
				煤矿企业节点:<el-tag>peer0.org1.trace.com</el-tag>&nbsp;&nbsp;&nbsp;<br><br>
				语音记录员节点:<el-tag>peer0.org2.trace.com</el-tag>&nbsp;&nbsp;&nbsp;<br><br>
				监管机构节点:<el-tag>peer0.org3.trace.com</el-tag>&nbsp;&nbsp;&nbsp;<br><br>
				生产环境记录员节点:<el-tag>peer0.org4.trace.com</el-tag>&nbsp;&nbsp;&nbsp;<br><br>
				物流节点:<el-tag>peer0.org5.trace.com</el-tag>&nbsp;&nbsp;&nbsp;<br><br>
				</div>
			</el-card>
		</el-card>
