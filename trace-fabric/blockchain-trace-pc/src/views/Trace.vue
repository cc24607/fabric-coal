      ...
      <el-col :span="16">
        ...
        <div>
          <el-row>
            <el-col :span="6">
              <el-form>
                <el-form-item><span style="color: #13CE66;">煤矿基本信息</span></el-form-item>
                <el-form-item label="所属煤矿企业:">{{ productData.factory }}</el-form-item>
                <el-form-item label="企业负责人:">{{ productData.leader }}</el-form-item>
                <el-form-item label="企业负责人电话:">{{ productData.leader_tel }}</el-form-item>
                <el-form-item label="产量:">{{ productData.Net_Content }}</el-form-item>
                <el-form-item label="开采车间:">{{ productData.workshop }}</el-form-item>
                <el-form-item label="开采工时">{{ productData.work_hours }}</el-form-item>
                <el-form-item label="保存方法">{{ productData.keep_mathod }}</el-form-item>
                <el-form-item label="额外说明">{{ productData.cooking_recommend }}</el-form-item>
              </el-form>
            </el-col>
            <el-col :span="6">
              <el-form>
            ...
            <el-col :span="12">
              <el-tabs v-model="activeName" @tab-click="handleClick">
                  ...
                  <el-row :gutter="8">
                    <el-col :span="24" v-for="(info, index) in cropsProcessDetailsArray" :key="index" style="padding-top: 10px;">
                      <el-card style="border-color: #42b983;">
                        <el-col :span="12">
                          <el-row>
                            <el-col :span="24">设备情况：{{ info.grow_status }}</el-col>
                          </el-row>
                          <br />
                          <el-row>
                            <el-col :span="24">光线情况：{{ info.illumination_status }}</el-col>
                          </el-row>
                          <br />
                          <el-row>
                            <el-col :span="24">湿度：{{ info.water_content }}</el-col>
                          </el-row>
                          <br />
                          <el-row>
                          ...
                          <br />
                          <el-row>
                            <el-col :span="24">溯源码：{{ info.remarks }}</el-col>
                          </el-row>
                        </el-col>
                ...
                <el-tab-pane label="监管机构审查" name="3">
                  <el-card style="border-color: #42b983;">
                    <el-col :span="12">
                      <el-row>
                        <el-col :span="24">管理员姓名：{{ machingInfo.leader }}</el-col>
                      </el-row>
                      <br /><br />
                      <el-row>
                      ...
                      <br /><br />
                      <el-row>
                        <el-col :span="24">监管机构：{{ machingInfo.factory_name }}</el-col>
                      </el-row>
                      <br /><br />
                      <el-row>
                        <el-col :span="24">读取时间：{{ machingInfo.in_factory_time }}</el-col>
                      </el-row>
                      <br /><br />
                      <el-row>
                        <el-col :span="24">完成审核时间：{{ machingInfo.out_factory_time }}</el-col>
                      </el-row>
                      <br /><br />
                      <el-row>
                        <el-col :span="24">审核结果：{{ machingInfo.testing_result }}</el-col>
                      </el-row>
                      <br /><br />
                      <el-row>
                        <el-col :span="24">溯源码：{{ machingInfo.remarks }}</el-col>
                      </el-row>
                      <br />
                    </el-col>
                ...
                <el-tab-pane label="关键信息" name="5">
                  <el-card style="border-color: #42b983;">
                    <el-row><el-col :span="24">操作员(语音转文本)姓名：{{ cropsDetails.crops_name }}</el-col></el-row><br><br>
                    <el-row><el-col :span="24">通话人员1：{{ cropsDetails.farmer_name }}</el-col></el-row><br><br>
                    <el-row><el-col :span="24">通话人员1电话：{{ cropsDetails.farmer_tel }}</el-col></el-row><br><br>
                    <el-row><el-col :span="24">地址：{{ cropsDetails.address }}</el-col></el-row><br><br>
                    <el-row><el-col :span="24">通话方式：{{ cropsDetails.plant_mode }}</el-col></el-row><br><br>
                    <el-row><el-col :span="24">通话时长：{{ cropsDetails.year }}</el-col></el-row><br><br>
                    <el-row><el-col :span="24">处理编号：{{ cropsDetails.bagging_status }}</el-col></el-row><br><br>
                    <el-row><el-col :span="24">通话人员2：{{ cropsDetails.fertilizer_name }}</el-col></el-row><br><br>
                    <el-row><el-col :span="24">通话人员2电话：{{ cropsDetails.grow_seedlings_cycle }}</el-col></el-row><br><br>
                    <el-row><el-col :span="24">原始语音哈希：{{ cropsDetails.irrigation_cycle }}</el-col></el-row><br><br>
                    <el-row><el-col :span="24">关键信息摘要：{{ cropsDetails.weed_cycle }}</el-col></el-row><br><br>
                    <el-row><el-col :span="24">审查结果：{{ cropsDetails.apply_fertilizer_cycle }}</el-col></el-row><br><br>
                    <el-row><el-col :span="24">审查时间：{{ cropsDetails.register_time }}</el-col></el-row><br><br>
                    <el-row><el-col :span="24">溯源码：{{ cropsDetails.remarks }}</el-col></el-row><br>
                  </el-card>
                </el-tab-pane>
              </el-tabs>
            </el-col>
